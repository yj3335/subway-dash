...
- **Spark micro-batch duration:** Target ≤ 25 seconds within the 30-second trigger interval.
...
- **API response time:** `/api/v1/stations/all` served from a 12-second TTL in-memory cache, reducing MongoDB aggregation load.
